...
sudo apt-get install libjpeg-dev vlc git python3-pip python3-pygame ffmpeg libsdl2-ttf-dev libsdl2-image-2.0-0 libfreetype6-dev libsdl2-ttf-2.0-0 libsdl2-mixer-2.0-0 -y
